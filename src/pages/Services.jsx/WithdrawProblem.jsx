...
function WithdrawalProblem() {
  ...
  const withdrawHistory = async (t) => {
    ...
    try {
      let res;
      let url = `${apis?.withdraw_pending_list}${userId}`;
        ...
        <div className="px-3 mt-3">
          {withdrawHistoryData && withdrawHistoryData?.length > 0 ? (
            withdrawHistoryData
              ...
              ?.map((item, i) => (
                <div className="bg-white rounded-lg p-2 mt-2" key={i}>
                  ...
                  {/* <div className="flex mt-4 text-black justify-between items-center">
                                        ...
                                        <p className="text-xsm text-black font-semibold">{item?.type === 0 ? "USDT" :item?.type === 1? "Indian Pay":"Camlenio"}</p>
                                    </div> */}
                  <div className="flex mt-4 text-black justify-between items-center">
                  ...
                  <div className="flex my-4 text-black justify-between items-center">
                  ...
                  {item.status === 1 && (
                    <button
                      ...
                      onClick={() => {
                        navigate("/customerservices/withdrawProblemform", {
                          state: {
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                <button
                  ...
                  className={`${
                    modalFirstValue === 0 ? "text-customlightbtn" : "text-black"
                  }`}
                >
                  All
                </button>
                <button
                  ...
                  className={`${
                    modalFirstValue === 1 ? "text-customlightbtn" : "text-black"
                  }`}
                >
                  To be Paid
                </button>
                <button
                  ...
                  className={`${
                    modalFirstValue === 2 ? "text-customlightbtn" : "text-black"
                  }`}
                >
                  Paid
                </button>
                <button
                  ...
                  className={`${
                    modalFirstValue === 3 ? "text-customlightbtn" : "text-black"
                  }`}
                >
                  Rejected
                </button>
                ...
                <div className="flex flex-col items-center overflow-y-auto h-40 hide-scrollbar">
                  {months.map((month) => (
                    <div
                      ...
                      className={`cursor-pointer py-2 px-4 ${
                        selectedDate.month === month ? "text-bg3" : "text-gray"
                      }`}
                    >
                      {month}
                    </div>
