...
import passwordUsa from "../assets/usaAsset/password2.png";
import passwordUsa1 from "../assets/usaAsset/password.png";
...
import LoginSuccessPopup from "./LoginSuccessFull"
    ...
    <>
      ...
      <section className="h-[100vh] font-inter w-full flex  flex-col items-start dark:text-white">
        <div className="bg-gradient-to-l from-red to-redLight w-full pb-5">
          <h1 className="text-sm font-bold font-inter px-6 mt-2">Log in</h1>
          <p className="text-[10px] px-6 mt-2">
              ...
              >
                {togglelogin ? (
                  <div className="">
                    <div className=" flex items-center gap-2 py-2 ">
                      <div>
                        <img className="w-6 h-5" src={email_tab} alt="sd" />
                      </div>
                      <label
                        htmlFor="mobile"
                    ...
                    <div className="relative flex items-center gap-2 ju">
                      <input
                        ...
                        className="col-span-[60%] bg-customdarkBlue text-[14px] border-[1px] border-transparent focus:border-customlightBlue rounded-md outline-none w-full pl-3 p-3 placeholder:text-gray text-white transition-all duration-200 ease-in-out"
                ...
                <div className="relative">
                  <div className="flex items-center py-2 gap-2">
                    <div>
                      <img className="w-6 h-6" src={passwordUsa1} alt="sd" />
                    </div>
                    <label
                      htmlFor="password"
                      className="text-sm text-white font-medium"
                ...
                <div className="flex flex-col font-bold items-center justify-center">
                  <button
                    type="submit"
                    className="w-[90%] font-bold tracking-[0.20333rem] py-2.5 text-[#8F5206]
                  rounded-full border-none bg-gradient-to-r from-[#EDD188] to-[#CA9D4B] shadow-lg flex items-center justify-center"
                  >
                    Log in
                  </button>
                  <button className="w-[90%] border border-[#7E6839] mt-5 tracking-[2px] rounded-full p-2">
                    {" "}
                    <Link
                      to="/register"
                      className="font-bold text-sm hover:underline text-[#D9AC4F] tracking-[0.20333rem] "
                    >
                      Register
                    </Link>
                  </button>
